#pragma checksum "C:\Users\darre\source\repos\RetailGInvoices\RetailGInvoices\Pages\Expenses.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fe089653852b824ce06515055756138e2f4e2b79"
// <auto-generated/>
...
#line 263 "C:\Users\darre\source\repos\RetailGInvoices\RetailGInvoices\Pages\Expenses.razor"
	...
	private Heading[] expenseHeadings;
	...
	Heading expenseHeadingObj = new Heading();
	...
	private string expenseHeadingSelectedName
	{
		...
		set
		{
			Heading tempHeading = Array.Find<Heading>(expenseHeadings, f => f.Description == value);
			if (tempHeading != null)
			{
			...
			{
				Heading expenseHeading = new Heading();
	...
	private async Task addNewHeading(Heading newHeading)
	{
		await Http.PostJsonAsync<Heading>("/api/Headings", newHeading);
		expenseHeadings = await Http.GetJsonAsync<Heading[]>("/api/Headings");
